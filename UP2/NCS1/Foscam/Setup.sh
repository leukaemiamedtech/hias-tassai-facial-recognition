...
if [ ! -f "TassAI/UP2/NCS1/Foscam/Model/inception_resnet_v1.py" ]
then
...
cd TassAI/UP2/NCS1/Foscam/Model/20170512-110547
...
cd TassAI/UP2/NCS1/Foscam/Model/dlib

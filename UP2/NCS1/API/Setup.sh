...
echo "!! This program will setup everything you need to use the UP2 NCS1 Facial API Security System !!"
echo " "
...
if [ ! -f "TassAI/UP2/NCS1/API/Model/inception_resnet_v1.py" ]
then
...
cd TassAI/UP2/NCS1/API/Model/20170512-110547
...
cd TassAI/UP2/NCS1/API/Model/dlib

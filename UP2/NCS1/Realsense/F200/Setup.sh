...
if [ ! -f "TassAI/UP2/NCS1/Realsense/F200/Model/inception_resnet_v1.py" ]
then
...
cd TassAI/UP2/NCS1/Realsense/F200/Model/20170512-110547
...
then
    ...
    cd TassAI/UP2/NCS1/Realsense/F200/Model/20170512-110547/facenet_celeb_ncs
...
cd TassAI/UP2/NCS1/Realsense/F200/Model/dlib
...
cd librealsense
sed -i '10 a #include <functional>' src/types.h
...
export PYRS_LIBS=/usr/local/lib
export PYRS_INCLUDES=/usr/local/include/librealsense
cpp-enumerate-devices
pip3 install --user pyrealsense
